...
SET @GENERAL_GROUP_ID = 2;
SET @ANONYMOUS_ID = 2;

#
# Groups
#
INSERT INTO jforum_groups ( group_id, group_name, group_description ) VALUES (@ADMIN_GROUP_ID, '管理员', '管理员');
INSERT INTO jforum_groups ( group_id, group_name, group_description ) VALUES (@GENERAL_GROUP_ID, '普通用户', '普通用户');

# 
# Users
#
INSERT INTO jforum_users ( user_id, username, user_password, user_regdate, user_posts ) VALUES (@ADMIN_ID, 'Admin', '96e79218965eb72c92a549dd5a330112', NOW(), 1);

#
# User Groups
#
INSERT INTO jforum_user_groups (group_id, user_id) VALUES (@ADMIN_ID, @ADMIN_ID);
INSERT INTO jforum_user_groups (group_id, user_id) VALUES (@GENERAL_GROUP_ID, @GENERAL_GROUP_ID);
